...
class ClientTest extends TestCase
{
    ...
    public function testFormat()
    {
        ...
        $client = new Client(API_TOKEN, $client_mock);
        $result = $client->format($client->request('GET', 'posts/update'));
    ...
    public function testLastUpdatePosts()
    {
        ...
        $this->assertEquals($response, ['update_time' => '2020-05-13T15:37:07Z']);
    }
        ...
        $this->assertEquals($response, [
            ...
            "posts" => [
                [
                    ...
                    'hash' => '54439a52e2efc520d5f9e5e615b89a5d',
    ...
    public function testAllPosts()
    {
        ...
        $this->assertEquals($response, [
            [
                ...
                'description' => 'testing first site',
                'extended' => 'test1',
                'meta' => '3bad0cf612e5834221d7242b8fb0f2c4',
                'hash' => '6cfedbe75f413c56b6ce79e6fa102aba',
                'time' => '2020-05-27T03:13:23Z',
                'shared' => 'yes',
                'toread' => 'yes',
                'tags' => 'foo',
            ],
            [
                ...
                'description' => 'testing second site.',
                'extended' => 'test2',
                'meta' => 'c86f6de807c5fef2ddda6d2422e12eea',
                'hash' => 'ca1e6357399774951eed4628d69eb84b',
                'time' => '2020-05-27T03:13:21Z',
                'shared' => 'yes',
                'toread' => 'yes',
                'tags' => 'bar',
            ]
    ...
    public function testSuggestPost()
    {
        ...
        $this->assertEquals($response, [
            ...
            [
                'recommended' => ['bash', 'commands', 'Find', 'hacks']
            ]
        ]);
    }
    ...
    public function testGetTags()
    {
        ...
        $this->assertEquals($response, ['foo' => "11", "bar" => "4"]);
    }
    ...
    public function testUserSecret()
    {
        ...
        $this->assertEquals($response, '6493a84f72d86e7de130');
    }
    ...
    public function testUserToken()
    {
        ...
        $this->assertEquals($response, "XOG86E7JIYMI");
    }
    ...
    public function testNotesId()
    {
        ...
        $this->assertEquals($response, [
            ...
            'updated_at' => '2011-10-28 13:37:23',
            'length' => 556,
            'text' => '[2] One advantage startups have over established companies is that there are no discrimination laws about starting businesses. For example, I would be reluctant to start a startup with a woman who had small children, or was likely to have them soon. ..., you can discriminate on any basis you want about who you start it with.',
            'hash' => '0bbca3cba9246bbbda2c',
        ]);
    }
}
